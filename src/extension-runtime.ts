...
import type { RoastModeFixedThinkingLevel } from "./settings.js";
...
export function setRoastThinkingLevel(pi: ExtensionAPI, level: RoastModeFixedThinkingLevel) {
	(pi.setThinkingLevel as unknown as (level: RoastModeFixedThinkingLevel) => void)(level);
}
